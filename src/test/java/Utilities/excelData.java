...
public class excelData {
	...
	public static void createExcelFile() throws IOException {
		fos = new FileOutputStream(System.getProperty("user.dir")+"\\target\\OutputExcelData.xlsx");
		w = new XSSFWorkbook();
		XSSFSheet sheet1 = w.createSheet("Honda Bikes");
	...
	public static void setCellData(String value,String sheetName,int rownum,int cellnum) throws IOException {
		String file = System.getProperty("user.dir")+"\\target\\OutputExcelData.xlsx";
